...
var scriptsEvents = __webpack_require__(12);
$(function () {
...
var onCreateEvent = function onCreateEvent(event) {
  ...
  api.createEvent(data).then(ui.createEventSuccess).catch(ui.createEventFailure);
};
var getEvents = function getEvents(event) {
  event.preventDefault();
  api.index().then(ui.getEventsSuccess).catch(ui.getEventsFailure);
};
var onDeleteEvent = function onDeleteEvent(event) {
  console.log(event);
  var deleteID = $(this).parent().parent().parent().parent().attr('data-id');
  event.preventDefault();
  console.log(deleteID);
  api.deleteEvent(deleteID).then(ui.deleteEventSuccess).catch(ui.deleteEvnetFailure);
};
...
var onUpdateEvent = function onUpdateEvent(event) {
  ...
  event.preventDefault();
  api.updateEvent(data).then(ui.updateEventSuccess).catch(ui.updateEventFailure);
};

var onScheduleDone = function onScheduleDone(event) {
  $('.table-responsive').hide();
  $('.form-control').val('');
  $('#get').show();
};

var getNewSchedule = function getNewSchedule(event) {
...
var deleteEvent = function deleteEvent(data) {
  // console.log('data is ', data.event)
  return $.ajax({
...
var store = __webpack_require__(5);
var showEventsTemplate = __webpack_require__(16);
...
var getEventsFailure = function getEventsFailure() {
...
var updateEventSuccess = function updateEventSuccess(data) {
  $('#message').text('Edit Successful');
};
var updateEventFailure = function updateEventFailure() {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n\n   <!-- Developers, why are we using data-id and not just id? -->\n   <ul data-id=\""
    ...
    + "\">\n     <div class=\"containerHandler\">\n     <form class = \"edit-events\">\n<input type=\"hidden\" name=\"event[id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <h3 id=\"handler\">HAPPENINGS</h3>\n     <textarea id=\"list\"name=\"event[event_name]\">"
    + alias2(((helper = (helper = helpers.event_name || (depth0 != null ? depth0.event_name : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"event_name","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</textarea>\n       <h3 id=\"handler\">STUFF</h3>\n     <textarea id=\"list1\"name=\"event[stuff]\">"
    + alias2(((helper = (helper = helpers.stuff || (depth0 != null ? depth0.stuff : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"stuff","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</textarea>\n     <div>\n      <button class=\"delete-events\" type=\"click\">DELETE</button>\n    </div>\n      <input class=\"edit-events\" type=\"submit\" value=\"EDIT\">\n    </form>\n</ul>\n</div>\n\n";
